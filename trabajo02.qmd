...
El objetivo del presente estudio es determinar cuál es el destino más adecuado para el viaje de fin de curso utilizando distintas metodologías de decisión multicriterio implementadas en R.
...
De acuerdo con los resultados obtenidos observamos que **según el método AHP el destino** **más adecuado para el viaje de fin de curso es España**, con un peso global del 25,7 %, seguido de Interrail (18,3 %) e Islas Griegas (18,1 %).
