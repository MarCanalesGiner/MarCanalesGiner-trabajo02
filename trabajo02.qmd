...
# su(pesos) (compruebo que sumen 1)
```
...
Observamos que tenemos dos elementos en el núcleo, por ello vamos a intentar ver qué obtenemos cambiando el valor de alfa
...
-   España domina a todas las demás alternativas (Caribe, India, Sudeste Asiático, Islas Griegas e Interrail), siendo la opción con mayor dominancia global.

-   Interrail e Islas Griegas presentan también cierta fortaleza, dominando a varias alternativas, aunque son superadas por España.
...
Por tanto, **según el método ELECTRE, el viaje por España se considera la mejor alternativa** para el viaje de fin de carrera, al presentar un equilibrio favorable en la mayoría de los criterios y una posición dominante respecto al resto de destinos analizados.
...
A continuación, se observa que India domina a Sudeste Asiático y al Caribe, mientras que Caribe y Sudeste Asiático resultan incomparables entre sí, situándose además como las alternativas menos favorables del conjunto analizado.
