...
Comenzamos definiendo la matriz y los pesos:
...
Por tanto, **según el método ELECTRE, el viaje al Caribe se considera la mejor alternativa** para el viaje de fin de carrera, al presentar un equilibrio favorable en la mayoría de los criterios y una posición dominante respecto al resto de destinos analizados.
...
De acuerdo con los resultados obtenidos observamos que **según el método AHP el destino** **más adecuado para el viaje de fin de carrera es España**, con un peso global del 25,7 %, seguido de Interrail (18,3 %) e Islas Griegas (18,1 %).
...
Escribimos los pesos:

```{r}
pesos.criterios = c(35/100,1/10,2/10,2/10,15/100)
# sum(pesos.criterios) (compruebo que sumen 1)
tab.fpref = matrix(c(2,1000,0,0,
                     5, 1, 2.5, 0,
                     4, 0.5,2.5,0,
                     4, 1, 2, 0,
...
Tras aplicar el método Promethee I se observa que Interrail presenta el flujo entrante más alto y el saliente más bajo, lo que indica que domina de forma clara a la mayoría de las demás opciones. Esto se puede ver a su vez en la tabla de superación. Esto nos sugiere que la alternativa **preferida con el método Promethee I es Interrail**.

En segundo lugar se sitúan España e Islas Griegas que también presentan un buen balance entre dominancia y escasa subordinación.

En cambio, la India sería la siguiente opción, pero esta ya muestra un flujo saliente ligeramente mayor que el flujo entrante.

Por último, encontramos el Sudeste Asiático y el Caribe, pues, muestran flujos netos negativos, lo que significa que son superadas por la mayoría de las demás alternativas, y por tanto, serán menos recomendables.

No obstante, veamos el método Promethee II que es quien me va a permitir ordenar fácilmente las alternativas:
...
**Con el método Promethee II concluimos que Interrail sería la alternativa preferida** (al ser la de mayor flujo neto), seguida de las Islas Griegas, España, India, Sudeste Asiático, y por último, el Caribe.
